...
public class BezelImageView extends AppCompatImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mBorderDrawable == null) {
            mBorderDrawable = ContextCompat.getDrawable(context, R.drawable.transparent_circle_mask);
        }
...
public class BezelImageView extends ImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMaskDrawable = a.getDrawable(R.styleable.BezelImageView_maskDrawable);
        if (mMaskDrawable == null) {
//            mMaskDrawable = getResources().getDrawable(R.mipmap.transparent_nine_patch);
            mMaskDrawable = ContextCompat.getDrawable(context, R.drawable.transparent_nine_patch);
        }
        ...
        mBorderDrawable = a.getDrawable(R.styleable.BezelImageView_borderDrawable);
        if (mBorderDrawable == null) {
//            mBorderDrawable = getResources().getDrawable(R.drawable.transparent_circle_mask);
            mBorderDrawable = ContextCompat.getDrawable(context, R.drawable.transparent_circle_mask);
        }
        mBorderDrawable.setCallback(this);
...
//                Canvas.HAS_ALPHA_LAYER_SAVE_FLAG | Canvas.FULL_COLOR_LAYER_SAVE_FLAG
        ...
        canvas.saveLayer(mBoundsF, mMaskedPaint, Canvas.ALL_SAVE_FLAG);
        super.onDraw(canvas);
